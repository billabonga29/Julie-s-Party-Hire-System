...
def hire_window():
    ...
    customer_name_label = tk.Label(hire_root, text="Customer Name:", bg="#4682B4", font=("Verdana", 12))
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    customer_name_entry = tk.Entry(hire_root, width=20, bg="white", font=("Verdana", 12), validate="key", validatecommand=(alphabet, '%P'))
...
def return_window(receipt_number, hire_details):
    ...
    customer_name_label = tk.Label(return_root, text="Customer Name:", bg="#4682B4", font=("Verdana", 12))
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    ...
    item_returned_label = tk.Label(return_root, text="Item Hired:", bg="#4682B4", font=("Verdana", 12))
    ...
    output_text = tk.Text(return_root, wrap=tk.WORD, height=10, width=40, bg="white", font=("Verdana", 10))
...
def open_return_window():
    ...
    error_label = tk.Label(enter_receipt_root, text="", bg="#B0C4DE", font=("Verdana", 12), fg="black")
...
def main():
    ...
    quit_button = tk.Button(root, text="Quit", command=root.quit, width=10, bg="#4682B4", font=("Verdana", 12))
