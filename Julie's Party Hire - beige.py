...
def hire_window():
    ...
    hire_root.configure(bg="#f6f1e3")

    # Creates all the hire-related labels and widgets and places them in correct grid placement.
    hire_label = tk.Label(hire_root, text="Hire", font=("Gill Sans Ultra Bold Condensed", 24), bg="#f6f1e3", fg="black")
    hire_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)
    
    customer_name_label = tk.Label(hire_root, text="Customer Name:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    customer_name_entry = tk.Entry(hire_root, width=20, bg="white", font=("Calibri", 12))
    customer_name_entry.grid(row=1, column=1, padx=10, pady=10)

    receipt_number_label = tk.Label(hire_root, text="Receipt Number:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    receipt_number_label.grid(row=2, column=0, padx=10, pady=10)
    receipt_number = random.randint(1000, 9999)
    receipt_number_display = tk.Label(hire_root, text=receipt_number, bg="white", font=("Calibri", 12), fg="black")
    receipt_number_display.grid(row=2, column=1, padx=10, pady=10)

    item_hired_label = tk.Label(hire_root, text="Item Hired:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    item_hired_label.grid(row=3, column=0, padx=10, pady=10)
    item_hired_combo = ttk.Combobox(hire_root, values=["Chairs", "Tables", "Decorations", "Sound System", "Lighting"], width=20, font=("Calibri", 12))
    item_hired_combo.grid(row=3, column=1, padx=10, pady=10)
    
    amount_hired_label = tk.Label(hire_root, text="Amount Hired:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    amount_hired_label.grid(row=4, column=0, padx=10, pady=10)
    amount_hired_entry = tk.Entry(hire_root, width=10, bg="white", font=("Calibri", 12))
    amount_hired_entry.grid(row=4, column=1, padx=10, pady=10)

    output_text = tk.Text(hire_root, wrap=tk.WORD, height=5, width=30, bg="white", font=("Calibri", 10), fg="black")
    ...
    # Creates submit button and places it in its correct grid location.
    submit_button = tk.Button(hire_root, text="Submit", command=submit_hire, bg="#5b4f47", font=("Calibri", 12), fg="white")
    ...
    back_button = tk.Button(hire_root, text="Back", command=back_to_main, bg="#5b4f47", font=("Calibri", 12), fg="white")
...
def return_window(receipt_number, hire_details):
    ...
    return_root.configure(bg="#f6f1e3")
    ...
    return_label = tk.Label(return_root, text="Return", font=("Gill Sans Ultra Bold Condensed", 24), bg="#f6f1e3", fg="black")
    return_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)
    
    customer_name_label = tk.Label(return_root, text="Customer Name:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    customer_name_entry = tk.Entry(return_root, width=20, font=("Calibri", 12), fg="black")
    customer_name_entry.insert(0, stored_customer_name)
    customer_name_entry.config(state="disabled")
    customer_name_entry.grid(row=1, column=1, padx=10, pady=10)

    receipt_number_label = tk.Label(return_root, text="Receipt Number:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    receipt_number_label.grid(row=2, column=0, padx=10, pady=10)
    receipt_number_entry = tk.Entry(return_root, width=10, font=("Calibri", 12), fg="black")
    ...
    item_returned_label = tk.Label(return_root, text="Item Hired:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    item_returned_label.grid(row=3, column=0, padx=10, pady=10)
    item_returned_entry = tk.Entry(return_root, width=20, font=("Calibri", 12), fg="black")
    ...
    amount_hired_label = tk.Label(return_root, text="Amount Hired:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    amount_hired_label.grid(row=4, column=0, padx=10, pady=10)
    amount_hired_entry = tk.Entry
    ...
    amount_returned_label = tk.Label(return_root, text="Amount Returned:", bg="#5b4f47", font=("Calibri", 12))
    amount_returned_label.grid(row=5, column=0, padx=10, pady=10)
    amount_returned_entry = tk.Entry(return_root, width=10, font=("Calibri", 12))
    amount_returned_entry.grid(row=5, column=1, padx=10, pady=10)

    output_text = tk.Text(return_root, wrap=tk.WORD, height=10, width=50, bg="white", font=("Calibri", 10))
    ...
    submit_button = tk.Button(return_root, text="Submit", command=submit_return, bg="#5b4f47", font=("Calibri", 12))
    submit_button.grid(row=5, column=0, columnspan=2, padx=10, pady=10)
    ...
    back_button = tk.Button(return_root, text="Back", command=back_to_main, bg="#5b4f47", font=("Calibri", 12))
    back_button.grid(row=7, column=0, columnspan=2, padx=10, pady=10)
...
def open_return_window():
    ...
    def on_validate():
        ...
        if hire_details:
            ...
            error_label.config(text="Invalid receipt number. Please try again.", bg="#5b4f47")

    # Sets up the pop-up window.
    enter_receipt_root = tk.Toplevel(root)
    enter_receipt_root.title("Enter Receipt Number")
    enter_receipt_root.configure(bg="#f6f1e3")

    # Creates the labels and buttons and places them in the correct grid placement.
    receipt_number_label = tk.Label(enter_receipt_root, text="Receipt Number:", bg="#5b4f47", font=("Calibri", 12), fg="white")
    receipt_number_label.grid(row=0, column=0, padx=10, pady=10)
    global receipt_number_entry
    receipt_number_entry = tk.Entry(enter_receipt_root, width=15, font=("Calibri", 12), fg="white")
    receipt_number_entry.grid(row=0, column=1, padx=20, pady=10)

    validate_button = tk.Button(enter_receipt_root, text="Validate", command=on_validate, bg="#5b4f47", font=("Calibri", 12), fg="white")
    validate_button.grid(row=1, column=0, columnspan=2, padx=10, pady=10)

    error_label = tk.Label(enter_receipt_root, text="", font=("Calibri", 12), fg="white")
...
def history():
    ...
    history_root.configure(bg="#f6f1e3")

    header_label = tk.Label(history_root, text="Hire History", font=("Gill Sans Ultra Bold Condensed", 20), bg="#f6f1e3")
    ...
    style = ttk.Style()
    style.configure("Treeview", background="#f6f1e3",
                    foreground="black", fieldbackground="#f6f1e3")
    style.configure("Treeview.Heading", background="#5b4f47",  
                    foreground="black")
    ...
    back_button = tk.Button(history_root, text="Back", command=back_to_main, bg="#5b4f47", font=("Calibri", 12), fg="white")
...
def main():
    ...
    root.configure(bg="#f6f1e3")

    # Creates all the labels and buttons and places them in the correct grid placement.
    logo = [ImageTk.PhotoImage(Image.open("logo_beige.png").resize((300,180)))]
    main_menu_label = tk.Label(root, image=logo, bg="#f6f1e3")
    main_menu_label.grid(row=1, column=0, columnspan=2, padx=0, pady=20)

    hire_button = tk.Button(root, text="Hire", command=hire_window, width=10, bg="#5b4f47", font=("Calibri", 12), fg="white")
    hire_button.grid(row=2, column=0, pady=10)

    return_button = tk.Button(root, text="Return", command=open_return_window, width=10, bg="#5b4f47", font=("Calibri", 12), fg="white")
    return_button.grid(row=2, column=1, pady=10)

    history_button = tk.Button(root, text="History", command=history, width=10, bg="#5b4f47", font=("Calibri",12), fg="white")
    history_button.grid(row=3, column=0, pady=10)

    quit_button = tk.Button(root, text="Quit", command=root.quit, width=10, bg="#5b4f47", font=("Calibri", 12), fg="white")
