...
def hire_window():
    ...
    receipt_number_label.grid(row=3, column=0, padx=10, pady=5)
    receipt_number_display = tk.Label(inner_frame, text=receipt_number, bg="white", font=("Verdana", 10), width=15, fg="white")
    receipt_number_display.grid(row=3, column=1, padx=10, pady=5)

    item_hired_label = tk.Label(inner_frame, text="Item Hired:",**label_style)
    item_hired_label.grid(row=4, column=0, padx=10, pady=5)
    item_hired_combo = ttk.Combobox(inner_frame, values=["Chairs", "Tables", "Decorations", "Sound System", "Lighting"], width=13, font=("Verdana", 10), state="readonly")
...
def return_window(receipt_number, hire_details):
    ...
    first_name_display.grid(row=1, column=1, padx=10, pady=10)
    ...
    last_name_display.grid(row=2, column=1, padx=10, pady=10)
...
def history():
    ...
    tree = ttk.Treeview(inner_frame, columns=("First Name","Last Name", "Receipt Number", "Item Hired", "Amount Hired"), show="headings")
    style = ttk.Style()
