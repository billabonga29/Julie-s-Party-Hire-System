...
def history():
    ...
    history_root.configure(bg="#FFA500")

    header_label = tk.Label(history_root, text="Hire History", font=("Comic Sans MS", 20), bg="#FFA500")
    ...
    back_button = tk.Button(history_root, text="Back", command=back_to_main, bg="#FFA500", font=("Comic Sans MS", 12))
...
def main():
    ...
    #FONTS Corbel,Gill Sans Ultra Bold Condensed, Script MT Bold, Bodoni MT Black
    ...
    main_menu_label.grid(row=1, column=0, columnspan=2, padx=20, pady=20)
    ...
    history_button = tk.Button(root, text="History", command=history, width=10, bg="#FFA500", font=("Comic Sans MS",12))
