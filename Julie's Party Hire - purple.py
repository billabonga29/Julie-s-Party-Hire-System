...
def hire_window():
    ...
    hire_root.configure(bg="#e4daf7")

    # Creates all the hire-related labels and widgets and places them in correct grid placement.
    hire_label = tk.Label(hire_root, text="Hire", font=("Script MT Bold", 24), bg="#e4daf7")
    hire_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)
    
    customer_name_label = tk.Label(hire_root, text="Customer Name:", bg="#aa8ce4", font=("Verdana", 12))
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    customer_name_entry = tk.Entry(hire_root, width=20, bg="white", font=("Verdana", 12))
    customer_name_entry.grid(row=1, column=1, padx=10, pady=10)

    receipt_number_label = tk.Label(hire_root, text="Receipt Number:", bg="#aa8ce4", font=("Verdana", 12))
    ...
    item_hired_label = tk.Label(hire_root, text="Item Hired:", bg="#aa8ce4", font=("Verdana", 12))
    item_hired_label.grid(row=3, column=0, padx=10, pady=10)
    item_hired_combo = ttk.Combobox(hire_root, values=["Chairs", "Tables", "Decorations", "Sound System", "Lighting"], width=20, font=("Verdana", 12))
    item_hired_combo.grid(row=3, column=1, padx=10, pady=10)
    
    amount_hired_label = tk.Label(hire_root, text="Amount Hired:", bg="#aa8ce4", font=("Verdana", 12))
    amount_hired_label.grid(row=4, column=0, padx=10, pady=10)
    amount_hired_entry = tk.Entry(hire_root, width=10, bg="white", font=("Verdana", 12))
    ...
    submit_button = tk.Button(hire_root, text="Submit", command=submit_hire, bg="#aa8ce4", font=("Verdana", 12))
    ...
    back_button = tk.Button(hire_root, text="Back", command=back_to_main, bg="#aa8ce4", font=("Verdana", 12))
...
def return_window(receipt_number, hire_details):
    ...
    return_root.configure(bg="#e4daf7")
    ...
    return_label = tk.Label(return_root, text="Hire", font=("Script MT Bold", 24), bg="#e4daf7")
    return_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)
    
    customer_name_label = tk.Label(return_root, text="Customer Name:", bg="#aa8ce4", font=("Verdana", 12))
    customer_name_label.grid(row=1, column=0, padx=10, pady=10)
    customer_name_entry = tk.Entry(return_root, width=20, font=("Verdana", 12))
    customer_name_entry.insert(0, stored_customer_name)
    customer_name_entry.config(state="disabled")
    customer_name_entry.grid(row=1, column=1, padx=10, pady=10)

    receipt_number_label = tk.Label(return_root, text="Receipt Number:", bg="#aa8ce4", font=("Verdana", 12))
    receipt_number_label.grid(row=2, column=0, padx=10, pady=10)
    receipt_number_entry = tk.Entry(return_root, width=10, font=("Verdana", 12))
    ...
    item_returned_label = tk.Label(return_root, text="Item Hired:", bg="#aa8ce4", font=("Verdana", 12))
    item_returned_label.grid(row=3, column=0, padx=10, pady=10)
    item_returned_entry = tk.Entry(return_root, width=20, font=("Verdana", 12))
    ...
    amount_hired_label = tk.Label(return_root, text="Amount Hired:", bg="#aa8ce4", font=("Verdana", 12))
    amount_hired_label.grid(row=4, column=0, padx=10, pady=10)
    amount_hired_entry = tk.Entry(return_root, width=10, font=("Verdana", 12))
    ...
    amount_returned_label = tk.Label(return_root, text="Amount Returned:", bg="#aa8ce4", font=("Verdana", 12))
    amount_returned_label.grid(row=5, column=0, padx=10, pady=10)
    amount_returned_entry = tk.Entry(return_root, width=10, font=("Verdana", 12))
    amount_returned_entry.grid(row=5, column=1, padx=10, pady=10)

    output_text = tk.Text(return_root, wrap=tk.WORD, height=10, width=50, bg="white", font=("Verdana", 10))
    ...
    submit_button = tk.Button(return_root, text="Submit", command=submit_return, bg="#aa8ce4", font=("Verdana", 12))
    submit_button.grid(row=5, column=0, columnspan=2, padx=10, pady=10)
    ...
    back_button = tk.Button(return_root, text="Back", command=back_to_main, bg="#aa8ce4", font=("Verdana", 12))
    back_button.grid(row=7, column=0, columnspan=2, padx=10, pady=10)
...
def open_return_window():
    ...
    def on_validate():
        ...
        if hire_details:
            ...
            error_label.config(text="Invalid receipt number. Please try again.", bg="#aa8ce4")

    # Sets up the pop-up window.
    enter_receipt_root = tk.Toplevel(root)
    enter_receipt_root.title("Enter Receipt Number")
    enter_receipt_root.configure(bg="#e4daf7")

    # Creates the labels and buttons and places them in the correct grid placement.
    receipt_number_label = tk.Label(enter_receipt_root, text="Receipt Number:", bg="#aa8ce4", font=("Verdana", 12))
    receipt_number_label.grid(row=0, column=0, padx=10, pady=10)
    global receipt_number_entry
    receipt_number_entry = tk.Entry(enter_receipt_root, width=15, font=("Verdana", 12))
    receipt_number_entry.grid(row=0, column=1, padx=10, pady=10)

    validate_button = tk.Button(enter_receipt_root, text="Validate", command=on_validate, bg="#aa8ce4", font=("Verdana", 12))
    validate_button.grid(row=1, column=0, columnspan=2, padx=10, pady=10)

    error_label = tk.Label(enter_receipt_root, text="", bg="#e4daf7", font=("Verdana", 12), fg="black")
...
def history():
    ...
    history_root.configure(bg="#e4daf7")

    header_label = tk.Label(history_root, text="Hire History", font=("Script MT Bold", 20), bg="#e4daf7")
    ...
    style = ttk.Style()
    style.configure("Treeview", background="#e4daf7",
                    foreground="black", fieldbackground="#e4daf7")
    style.configure("Treeview.Heading", background="#aa8ce4",  
                    foreground="black")
    ...
    back_button = tk.Button(history_root, text="Back", command=back_to_main, bg="#aa8ce4", font=("Verdana", 12))
...
def main():
    ...
    root.configure(bg="#e4daf7")

    # Creates all the labels and buttons and places them in the correct grid placement.
    logo = [ImageTk.PhotoImage(Image.open("logo_purple.png").resize((300,180)))]
    main_menu_label = tk.Label(root, image=logo, bg="#e4daf7")
    main_menu_label.grid(row=1, column=0, columnspan=2, padx=0, pady=20)

    hire_button = tk.Button(root, text="Hire", command=hire_window, width=10, bg="#aa8ce4", font=("Verdana", 12))
    hire_button.grid(row=2, column=0, pady=10)

    return_button = tk.Button(root, text="Return", command=open_return_window, width=10, bg="#aa8ce4", font=("Verdana", 12))
    return_button.grid(row=2, column=1, pady=10)

    history_button = tk.Button(root, text="History", command=history, width=10, bg="#aa8ce4", font=("Verdana",12))
    history_button.grid(row=3, column=0, pady=10)

    quit_button = tk.Button(root, text="Quit", command=root.quit, width=10, bg="#aa8ce4", font=("Verdana", 12))
